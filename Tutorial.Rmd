...
Unlike a correlation (Spearman's Rho or Kendall's Tau), a regression will allow you input multiple variables into your model to account for other factors that could effecting the price of the diamond which will help you better predict the price. 

So let’s control for the depth of a diamond:
...
If we just look at reg1, that's the object we just created, it's gonna give us just the coefficients. It gives us the call there and it gives us the coefficients and you can see, for instance, that some of them are positive, some of them are negative. 
