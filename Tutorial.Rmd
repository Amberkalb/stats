...
By creating a scatterplot, we are able to see that there is a positive relationship between the carat size and cost of a diamond. But we do not know the exact strength of that relationship (to what degree they co-vary), and what if the cost of the diamond had a more ambigious relationship with another predictor variable, such as depth? 
