...
The strength of Pearson’s correlation indicates that the model is a good fit: __strong relationship__ (perfect, positive relationship at 1, no relationship between the variables at 0, and a perfect negative relationship at -1). The carat size explains approxiamtely __92%__ of the dependent variable: the price of the diamond. In other words, approx. 8% of the variation in price is unexplained by carat size probably due to the influence of other variables (and measurement error, etc.).   
