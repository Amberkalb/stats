...
library("Hmisc")
attach(diamonds)
plot(price, carat, main="Scatterplot Example", 
...
```{r}
attach(diamonds)
plot(price, depth, main="Scatterplot Example 2", 
  	xlab="price", ylab="dpeth") +
...
Pearson’s corr: strong relationship (perfect at 1, at 0 no relationship between variables (range -1 to 1) and positive (there would a neg sign if otherwise).  Can only use for linear relationship, so scatterplot the data first to illustrate the relationship Linear or nonlinear. 
